...
export function renderPluginsListPage(data: PluginsListPageData): string {
  const pageContent = `
    <div>
      ...
      <!-- Filters -->
      <div class="mb-6">
        <div class="rounded-md bg-white dark:bg-zinc-900 shadow-sm ring-1 ring-zinc-950/10 dark:ring-white/10">
          <div class="px-6 py-5">
            <div class="flex items-center justify-between">
              <div class="flex items-center gap-4 flex-1">
                <div class="flex-1 max-w-md">
                  ...
                  <div class="relative group">
                    <div class="absolute left-3 top-2.5 flex items-center justify-center pointer-events-none">
                      <svg class="h-4 w-4 text-zinc-400 dark:text-zinc-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
                    ...
                    <input
                      ...
                      class="w-full rounded-full border-0 bg-white dark:bg-zinc-900 py-1.5 pl-10 pr-3 text-zinc-900 dark:text-zinc-100 ring-1 ring-inset ring-zinc-300 dark:ring-zinc-700 placeholder:text-zinc-400 focus:ring-2 focus:ring-inset focus:ring-zinc-600 dark:focus:ring-zinc-400 sm:text-sm sm:leading-6"
                    />
                  </div>
                </div>
                <div>
                  ...
                  <div class="mt-2 grid grid-cols-1">
                    <select id="category-filter" onchange="filterAndSortPlugins()" class="col-start-1 row-start-1 w-full appearance-none rounded-md bg-white dark:bg-zinc-900 py-1.5 pl-3 pr-8 text-base text-zinc-900 dark:text-zinc-100 outline outline-1 -outline-offset-1 outline-zinc-300 dark:outline-zinc-700 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-zinc-600 dark:focus:outline-zinc-400 sm:text-sm/6 min-w-48">
                    ...
                    <svg viewBox="0 0 16 16" fill="currentColor" data-slot="icon" aria-hidden="true" class="pointer-events-none col-start-1 row-start-1 mr-2 size-5 self-center justify-self-end text-zinc-500 dark:text-zinc-400 sm:size-4">
                ...
                <div>
                  <label class="block text-sm/6 font-medium text-zinc-950 dark:text-white">Sort By</label>
                  <div class="mt-2 grid grid-cols-1">
              ...
              <div class="flex items-center gap-x-3 ml-4">
                <button
                  ...
                  class="inline-flex items-center gap-x-1.5 px-3 py-1.5 bg-white dark:bg-zinc-900 text-zinc-700 dark:text-zinc-300 text-sm font-medium rounded-md ring-1 ring-inset ring-zinc-300 dark:ring-zinc-700 hover:bg-zinc-50 dark:hover:bg-zinc-800 transition-colors"
                >
